...
Vendored verbatim from labhai/ffhq-wrinkle-dataset (unet/unet_parts.py), which
derives from https://github.com/milesial/Pytorch-UNet and is distributed under
the GNU General Public License v3.0 (GPLv3). Do not edit the layer definitions:
the released stage2_unet.pth checkpoint must load against this exact structure.
"""
